...
const BLOG = {
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || 'd2b56efd-7301-4e28-a2e4-5256b35b726b', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '实迷途其未远,觉今是而昨非', // 站点描述，被notion中的页面描述覆盖
